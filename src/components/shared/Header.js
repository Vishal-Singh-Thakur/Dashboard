...
export default function Header() {
    ...
    return (
        <div className="bg-white h-16 px-8 flex justify-between items-center border-b border-gray-200">
            ...
            <div className="flex items-center gap-2 mr-2">
                    ...
                    {({ open }) => (
                        <>
                            ...
                            >
                                <Popover.Panel className="absolute right-0 z-10 mt-2.5 w-80">
                                    <div className="bg-white rounded-sm shadow-md ring-1 ring-black ring-opacity-5 px-2 py-2.5">
                                        <strong className="text-gray-700 font-medium">Notifiction</strong>
                                        <div className="mt-2 py-1 text-sm ">
                                            This is notifiction panel.
                                        </div>
                                    </div>
                                </Popover.Panel>
                            </Transition>
                ...
                <Menu as="div" className="relative">
                    ...
                    >
                        <Menu.Items className="origin-top-right z-10 absolute right-0 mt-2 w-28 rounded-sm shadow-md p-1 bg-white ring-1 ring-opacity-5 focus:outline-none">
                            <Menu.Item>
                                {({ active }) => (
                                    <div
                                        className={classNames(active && 'bg-gray-100',
                                            "text-gray-700 focus:bg-gray-200 cursor-pointer rounded-sm px-0.5 py-2"
                                        )}
